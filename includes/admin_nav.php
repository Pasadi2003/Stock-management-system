<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <div>
            <a class="navbar-brand" href="#">
                <img alt="SMS" src="./assets/images/logo1.png" style="width:150px; height: 50px; margin-top: -15px;">
            </a>
        </div>
    ...
    <ul class="dropdown-menu" role="menu">
        ...
        if ($_SESSION['role'] == 'admin') {
            ...
            echo '<li><a href="stock.php">Main Stock</a></li>';
        }
        ?>
                ...
                if($_SESSION['role'] == 'admin')
                {
                   echo '<li class="dropdown">
                    ...
                    <li class="dropdown">
                    <a href="#" class a
                    ="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Suppliers<span
                                class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
