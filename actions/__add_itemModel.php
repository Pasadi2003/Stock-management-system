...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    //connect to db
    require_once '../db.php';
    $sql = "INSERT INTO `item` (`item_name`, `item_cat`, `item_detail`, `bill_no`, `supplier_id`,'dept_id', `supplied_at`) VALUES ('" . $item_name . "',' " . $item_cat . "','" . $item_detail . "','" . $bill_no . "','" . $dept_id . "' ,'" . $supplier_id . "' , CURDATE())";
     //var_dump($sql);
